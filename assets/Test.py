...
class BrowserTab(QMainWindow):
    def __init__(self, Main, parent=None):
        ...
        # Adding Bottom Status Bar
        # self.status_bar = QStatusBar()
        # self.setStatusBar(self.status_bar)

        self.back_button = QAction(QIcon('assets/back.png'), 'Back', self)
        self.next_button = QAction(QIcon('assets/forward.png'), 'Next', self)
        self.stop_button = QAction(QIcon('assets/stop.png'), 'Stop', self)
        self.refresh_button = QAction(QIcon('assets/refresh.png'), 'Refresh', self)
        self.home_button = QAction(QIcon('assets/home.png'), 'Home', self)
        self.enter_button = QAction(QIcon('assets/enter.png'), 'Search', self)
        self.add_button = QAction(QIcon('assets/new.png'), 'New Tab', self)
        ...
        self.set_button = QAction(QIcon('assets/setting.png'), 'Settings', self)
